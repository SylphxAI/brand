...
| **Domain** | [sylphx.com](https://sylphx.com) | Live product |
...
- pdf-reader-mcp and broader MCP toolchain  
- Libraries (e.g. Rapid, etc.) under SylphxAI  
...
**Avoid:** SylphX, Sylph X, styling “SylphxAI” as the product name outside GitHub.

## Founder narrative

Founder role (portfolio): infrastructure AI agents run on — MCP, RAG/CodeRAG, AI-native PaaS.
